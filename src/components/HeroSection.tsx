      ...
      />
        <div className='p-4 relative z-10 w-full text-center'>
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
                Dive into comprehensive Software development courses
                and transform your development journey today. Whether 
                you are beginner or looking to refine you skills, join us
